...
var chemicals = [
  {
    ...
    longDescription: "The primary component in most conventional pads and tampons, providing the soft texture and absorbent core.",
  ...
  },
  {
    ...
    longDescription: "Applied to the outer surface of products to create a smoother feel and help manage moisture flow.",
  ...
  },
  {
    ...
    longDescription: "A versatile plastic used in the backsheets of pads and in some tampon applicators to create a moisture barrier.",
  ...
  },
  {
    ...
    longDescription: "Often hidden in 'fragrance' mixes or plastic components to make them pliable and scented.",
  ...
  },
  {
    ...
    longDescription: "Common synthetic preservatives that have been widely used in personal care products to maintain shelf stability.",
  ...
  },
  {
    ...
    longDescription: "A broad group of chemicals used in various manufacturing stages, sometimes remaining as traces in the final product.",
  ...
  },
  {
    ...
    longDescription: "A 'proprietary' mix that can contain thousands of unlisted chemicals used to mask or add scent.",
  ...
  },
  {
    ...
    longDescription: "Unintentional byproducts of chlorine bleaching used to whiten wood pulp and cotton.",
  ...
  },
  {
    ...
    longDescription: "Used for its anti-irritant properties, often found in liners designed for sensitive skin.",
  ...
  },
  {
    ...
    longDescription: "A natural material that provides excellent elasticity but is a common allergen.",
  ...
  },
  {
    ...
    longDescription: "The gold standard for menstrual cups due to its durability and biocompatibility.",
...
var chemicals_default = chemicals;

// netlify/functions/chat.ts
var client = new OpenAI({ apiKey: process.env.OPENAI_API_KEY });
function buildSystemPrompt(lang) {
  const isDE = lang === "de";
  const languageInstruction = isDE ? "Bitte antworten Sie ausschlie\xDFlich auf Deutsch. Verwenden Sie eine klare, sachliche Sprache f\xFCr ein allgemeines Publikum." : "Please respond in English. Use clear, accessible language for a general audience.";
...
CHEMICAL DATABASE:
${JSON.stringify(chemicals_default, null, 2)}
